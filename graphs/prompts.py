...
# before prompt
# datasets_extract_template = PromptTemplate.from_template(
#     '''
#     Instruction: Strict Dataset Filtering
#     Task: For the following question, retain only "directly relevant" datasets and remove all indirect or redundant options.
...
#         1. Keyword Extraction: Identify "Core Entities", "Action Verbs", and "Qualifiers" (e.g., time, location) from the question.

#         2. Initially retain relevant datasets.

#         3. Retain only the best datasets to the question, remove the worse one.

#         4. Return the answer strictly follow json_format at the end of the response.
