...
class AssistantGraph:
    def __init__(self):
        ...
        # builder.add_edge("analytics_planning_agent",
        #                  "analytics_execution_agent")
        # builder.add_edge("analytics_execution_agent",
        #                  "interpretation_agent")
        # builder.add_edge(
        #     ["google_search_agent", "analytics_execution_agent"], "interpretation_agent")
        builder.add_edge("filter_decision_agent", END)
